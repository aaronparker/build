...
BeforeDiscovery {
    ...
    $Scripts = Get-ChildItem -Path $Path -Include "*.ps1" -Recurse -Exclude "Enable-SysprepCryptoSysPrep_Specialize.ps1", "Install-MicrosoftVdot.ps1", "Remove-WinRmRemoting.ps1"
}
